...
def main():
    ...
    files = sorted(glob.glob("/projects/weilab/dataset/hydra/results/vesicle_small_*_30-8-8_patch.h5"))
    bbs = sorted(glob.glob("/projects/weilab/dataset/hydra/results/vesicle_small-bbs_*_30-8-8.h5"))
